...
def get_actv_net(net,epoch,relu):
    ###
    ## INPUT:
    #   1. net: network ID
    ...
    Unt_f500 = h5py.File('raw response/He/Relu'+str(relu)+'/Epochs/actv_f500_network'+str(net)+'_relu'+str(relu)+'_epoch'+str(epoch)+'.mat', 'r')
    actv_ = Unt_f500['actv'][:]
